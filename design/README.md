...
|---|---|---|
| [`TDS.md`](TDS.md) | **Technical Design Specification** — the requirements contract (FR-MB…, FR-S…, NFR-…) with measurable pass/fail criteria. The single source of truth for behaviour. | **v0.7** — 68 active requirements; hardened by a multi-agent audit + verification passes |
