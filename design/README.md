...
| [`softwareArchitecture.md`](softwareArchitecture.md) | **How** the requirements are met: the zero-ISR cooperative super-loop, the module split (capability-macro variant gating incl. `wind_combined`), and the sizing rationale with as-built numbers. §7 embeds the UML diagrams. | Agreed baseline; updated 2026-07-12 for the three-variant firmware |
