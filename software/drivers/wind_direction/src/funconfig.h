/**
 * @file funconfig.h
 * @brief ch32v003fun compile-time configuration for the wind direction driver build.
 *
 ...
 * design/driverDevelopment.md §2.1) and tracing goes over PD6. main.c's update
 * pacing computes ticks as FUNCONF_SYSTEM_CORE_CLOCK / 1000 per ms, so SysTick
 * runs on full HCLK (software/hil/README.md).
 */
#ifndef _FUNCONFIG_H
#define _FUNCONFIG_H
